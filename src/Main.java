...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("> Victor Conteúdos inscritos: " + dev1.getInscritos());
        dev1.progredir();
        dev1.progredir();
        dev1.progredir();
        System.out.println("-");
        System.out.println("> Victor Conteúdos concluídos: " + dev1.getConcluidos());
        System.out.println("> Victor Conteúdos inscritos: " + dev1.getInscritos());
        ...
        System.out.println("> Matheus Conteúdos inscritos: " + dev2.getInscritos());
        dev2.progredir();
        dev2.progredir();
        System.out.println("-");
        System.out.println("> Matheus Conteúdos concluídos: " + dev2.getConcluidos());
        System.out.println("> Matheus Conteúdos inscritos: " + dev2.getInscritos());
