...
public class Bootcamp {
    ...
    public boolean equals(Object o) {
        ...
        if (descricao == null) {
            ...
            return false;
        if (!dataInicial.equals(bootcamp.dataInicial))
            return false;
        if (!dataFinal.equals(bootcamp.dataFinal))
            return false;
        if (inscritos == null) {
            ...
            return false;
        if (conteudos == null) {
            return bootcamp.conteudos == null;
        } else return conteudos.equals(bootcamp.conteudos);
    }
